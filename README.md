...
| Tool | Description |
|:---|:---|
| `smithsonian_search` | Search across 19.4M objects by text query with optional filters (museum, type, decade, culture, place, media type, CC0). Returns curated summaries with total count. |
